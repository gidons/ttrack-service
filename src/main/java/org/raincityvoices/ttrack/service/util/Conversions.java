...
public class Conversions {
    ...
    public static List<TimedTextDTO> fromTimedTextData(TimedTextData data) {
    ...
    public static TimedTextDTO fromTimedTextEntries(AudioPart part, DataType type, List<TimedTextData.Entry> entries) {
